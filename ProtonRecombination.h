...
// Tue Oct 19 17:36:10 2021 by ROOT version 6.18/04
// from TChain protonmcnorw/PandoraBeam/
//////////////////////////////////////////////////////////

#ifndef ProtonRecombination_h
#define ProtonRecombination_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           primary_truth_byE_PDG;
   Int_t           primary_truth_byE_ID;
   ...
   TBranch        *b_primary_truth_byE_PDG;   //!
   TBranch        *b_primary_truth_byE_ID;   //!
   ...
   ProtonRecombination(TTree *tree=0);
   virtual ~ProtonRecombination();
...
#ifdef ProtonRecombination_cxx
ProtonRecombination::ProtonRecombination(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/pnfs/dune/persistent/users/hyliao/protodune/proton/v09_26_00/ana/PDSPProd4a_MC_1GeV_reco1_sce_datadriven_v1_nog4rw/mcproton_all.root/protonmcnorw/PandoraBeam");
      //chain->Add("/dune/data2/users/hyliao/protonana/v09_39_01/PDSPProd4a_MC_1GeV_DeltaRays/MC_sceon_all.root/protonmcnorw/PandoraBeam");
      tree = chain;
#endif // SINGLE_TREE
...
ProtonRecombination::~ProtonRecombination()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ProtonRecombination::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ProtonRecombination::LoadTree(Long64_t entry)
{
...
void ProtonRecombination::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("primary_truth_byE_PDG", &primary_truth_byE_PDG, &b_primary_truth_byE_PDG);
   fChain->SetBranchAddress("primary_truth_byE_ID", &primary_truth_byE_ID, &b_primary_truth_byE_ID);
...
Bool_t ProtonRecombination::Notify()
{
...
void ProtonRecombination::Show(Long64_t entry)
{
...
Int_t ProtonRecombination::Cut(Long64_t entry)
{
