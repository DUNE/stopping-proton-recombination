...
double calib_factor =1.067e-3; // the 'old' one I calculate
...
double betap = 0.202;//(kV/cm)(g/cm^2)/MeV
double alpha = 0.921;//parameter from ArgoNeuT experiment at 0.481kV/cm 
