...
// Sun Oct 25 23:04:36 2020 by ROOT version 6.18/04
// from TChain protonbeamana/beamana/
//////////////////////////////////////////////////////////

#ifndef ExtractTracks_run5387_h
#define ExtractTracks_run5387_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ExtractTracks_run5387(TTree *tree=0);
   virtual ~ExtractTracks_run5387();
...
#ifdef ExtractTracks_run5387_cxx
ExtractTracks_run5387::ExtractTracks_run5387(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      // production 4
      chain->Add("/dune/data2/users/waldron/protoDUNE/Beam_all.root/protonbeamana/beamana");
      // production 3
      //chain->Add("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/realdata/p1gev/code_timedep_trkpos/PDSPProd2/with_SCE_cali/Beam_all.root/protonbeamana/beamana");
      tree = chain;
#endif // SINGLE_TREE
...
ExtractTracks_run5387::~ExtractTracks_run5387()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ExtractTracks_run5387::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ExtractTracks_run5387::LoadTree(Long64_t entry)
{
...
void ExtractTracks_run5387::Init(TTree *tree)
{
...
Bool_t ExtractTracks_run5387::Notify()
{
...
void ExtractTracks_run5387::Show(Long64_t entry)
{
...
Int_t ExtractTracks_run5387::Cut(Long64_t entry)
{
...
#endif // #ifdef ExtractTracks_run5387_cxx
