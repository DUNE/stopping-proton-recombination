...
double calib_factor =5.03e-3;
double normalisation_factor=0.984;//for plane 2
TFile my_file0("./cali/YZcalo_r34797968.root");//YZ correction factors
TFile my_file2("./cali/Xcalo_r34797968.root"); //X correction factors
...
TFile *ef=new TFile("/dune/app/users/hyliao/WORK/analysis/protodune/proton/analysis/realdata/p1gev/code_timedep_trkpos/PDSPProd2/with_SCE_cali/cali_const_new/SCE_DataDriven_180kV_v3.root");
