...
double calib_factor =1.049e-3; // the 'old' one I calculate
double normalisation_factor=0.989;//0.988;//for plane 2
...
//const double rho= 1.383;//1.396;//g/cm^3
...
TFile my_file0("/dune/app/users/waldron/dev/2023/April/stopping-protons/cali_argoneut_box_2/YZcalo_mich2_r5387.root");
TFile my_file2("/dune/app/users/waldron/dev/2023/April/stopping-protons/cali_argoneut_box_2/Xcalo_mich2_r5387.root");
